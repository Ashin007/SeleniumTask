...
//        }
        ...
        int table_row = driver.findElements(By.xpath("//*[@id='liveWorldPop']/div[1]/div/div/div/div/div[2]/div[2]/div[2]/table/tbody/tr")).size();
        int table_col = driver.findElements(By.xpath("//*[@id='liveWorldPop']/div[1]/div/div/div/div/div[2]/div[2]/div[2]/table/thead/tr/th")).size();
